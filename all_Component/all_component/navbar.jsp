...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
  <a class="navbar-brand" href="#"><i class="fa fa-graduation-cap" aria-hidden="true"></i> ENotes</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="showNotes.jsp"><i class="fa fa-book" aria-hidden="true"></i> Show Notes</a>
      </li>
    </ul>
    <%
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div>
        <button type="button" class="bttn btn-primary" data-dismiss="modal">Close</button>
